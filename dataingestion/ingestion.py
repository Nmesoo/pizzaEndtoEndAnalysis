...
if __name__ == "__main__":
    ...
    db = PostgresDB(db_name="pizza", user="postgres", password="Goodybag1")

    #db = PostgresDB(db_name="pizza", user="postgres", password="ikpemosime")
    ...
    db.load_csv_to_db(r"Analytical_engineering\Data\pizza_type.csv", "pizza_types")
    db.load_csv_to_db(r"Analytical_engineering\Data\pizzas.csv", "pizzas")
    db.load_csv_to_db(r"Analytical_engineering\Data\orders_2023.csv", "orders_2023")
    db.load_csv_to_db(r"Analytical_engineering\Data\order_details_2023.csv", "order_details_2023")
    db.load_csv_to_db(r"Analytical_engineering\Data\orders_2024.csv", "orders_2024")
    db.load_csv_to_db(r"Analytical_engineering\Data\order_details_2024.csv", "order_details_2024")
    db.load_csv_to_db(r"Analytical_engineering\Data\orders_2025.csv", "orders_2025")
    db.load_csv_to_db(r"Analytical_engineering\Data\order_details_2025.csv", "order_details_2025")
